...
# Vendored install: resolve the bundled setup.py relative to this hook script
# (the plugin's $CLAUDE_PLUGIN_ROOT is not set for a project-vendored copy).
HOOK_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SETUP_PY="$HOOK_DIR/../../skills/watch/scripts/setup.py"
